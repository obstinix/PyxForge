...
pub fn handle_request(input: &str) -> Result<String, String> {
...
pub fn handle_ping() -> Result<String, String> {
...
pub fn handle_build(project_root_str: &str, profile_name: &str) -> Result<String, String> {
...
pub fn handle_list_profiles(project_root_str: &str) -> Result<String, String> {
    let project_root = PathBuf::from(project_root_str);
    if !project_root.exists() {
        return Err(format!(
            "project_root '{}' does not exist",
...
pub fn handle_launch(project_root_str: &str, debug_mode: bool) -> Result<String, String> {
    let project_root = PathBuf::from(project_root_str);
    if !project_root.exists() {
        return Err(format!(
            "project_root '{}' does not exist",
...
pub fn handle_stop(pid: u32, project_root_str: Option<&str>) -> Result<String, String> {
...
pub fn handle_qemu_status(pid: u32) -> Result<String, String> {
...
pub fn handle_qemu_monitor_cmd(
    project_root_str: &str,
    command: &str,
) -> Result<String, String> {
    let project_root = PathBuf::from(project_root_str);
...
pub fn handle_hex_dump(file_path_str: &str) -> Result<String, String> {
